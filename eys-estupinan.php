 ...
 <div style="float:left; width:60%; margin:60px auto; padding:1vw">
  ...
  <div style="width: 100%; height:100%;" >
           <div  style="text-align:justify; font-size: 20px;">
                   <p class="eys-parrafo">Soy Jairo Estupi?an, tengo 21 años de edad, nací en la ciudad de Manab?, actualmente soy estudiante de la Universidad Técnica Luis Vargas Torres, estudio la carrera de Ingenieria en Tecnologias de la Información. </p>
                   <p class="eys-parrafo">Desde que estaba en la basica veia videos de tecnologia en el internet y me llamo mucho la atencion y desde ah? decidi seguir la carrera de la Informatica.</p>
   ...
   <div id="blog-seccion2"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis estudios</h2> 
                   ...
                   <p class="eys-parrafo">Mis estudios secundarios los realice en el colegio Sagrado Coraz?n, donde seguí la carrera de informatica, donde adquiri mas conocimineto sobre lo que es la informatica y la ense?anza fueron muy buenas y escenciales para mi preparaci?n y aprendizaje.</p>
   ...
   <div id="blog-seccion4"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis Hooby</h2> 
                   ...
                   <p   class="eys-parrafo">En mis tiempos libre me gusta dibujar, hacer deporte, y siempre trato de aprender cosas nuevas viendo videos tutoriales.</p>
...
<script >  
 ...
 document.title="SoyJairo"; 
document.getElementById("foto").src="./images/jairo.jpg";
